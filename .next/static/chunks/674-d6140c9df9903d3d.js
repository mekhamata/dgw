...
`;var Ne=t=>{const{big:e=!1,direction:r,reverse:n=!1,...o}=t,s=(0,a.useMemo)((()=>function(t,e,r){switch(r){case"bottom-left":return e?ge:Qt;case"bottom-right":return e?be:te;case"down":return t?e?xe:re:e?ve:ee;case"left":return t?e?ke:ne:e?we:ae;case"right":return t?e?$e:se:e?Se:oe;case"top-left":return e?Ce:ie;case"top-right":return e?Oe:ce;case"up":return t?e?Ae:le:e?_e:fe;default:return e?he:Kt}}(e,n,r)),[e,r,n]);return Jt(ue,{keyframes:s,...o})};Vt`
  from {
...
`;var Ie=t=>{const{direction:e,reverse:r=!1,...n}=t,o=(0,a.useMemo)((()=>function(t,e){switch(e){case"down":return t?Ye:ze;case"right":return t?je:Ve;case"up":return t?Xe:Me;default:return t?Pe:Ee}}(r,e)),[e,r]);return Jt(ue,{keyframes:o,...n})};Vt`
  from {
    opacity: 0;
    transform: scale3d(0.3, 0.3, 0.3);
  }
